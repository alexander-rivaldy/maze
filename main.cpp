...
int main(int argc, char** argv)
{
    ...
    arg_processor processor(argc, argv);
...
void display_usage(void)
{
    ...
    std::cout << "You may enter several types of options to mazer. " 
        << "You may enter --ga or --ge for a " << std::endl;
    std::cout << "generate command, the command should be something like: " 
        << std::endl << std::endl;
    std::cout << "\t--ga seed width height, where seed, width and height "
    ...
    std::cout << "\t--ga is to generate a maze with Aldous Broder algorithm"
		<<std::endl;
	std::cout <<"\t--ge is to generate a maze with Eller's Algorithm"
		<<std::endl;
    ...
    std::cout << "You can save a maze as a svg file which you "
	...
	std::cout<<"Finally, you can also solve the maze and output a svg file"
		<<std::endl;
	std::cout<<"in which could display in a web browser. You may specify"
		<<"this as follows:"<<std::endl;
	std::cout<<"\t --pb somevector.svg, where the maze will be solve with "
		<<"Breadth First Algorithm"<<std::endl;
	std::cout<<"\t --pd somevector.svg, where the maze will be solve with "
		<<"Depth First Algorithm"<<std::endl;
	std::cout<<"\t --pm somevector.svg, where the maze will be solve with "
		<<"Djikstra Algorithm with Manhattan"<<std::endl;
	std::cout<<"\t --pb somevector.svg, where the maze will be solve with "
		<<"Djikstra Algorithm with Euclidean"<<std::endl;
}
